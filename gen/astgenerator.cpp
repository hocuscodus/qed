...
int main(int argc, const char *argv[]) {
  ...
  const char *array[] = {
    ...
    "Call        : bool newFlag, Expr* callee, Token paren, Expr* params, Expr* handler, Declaration* _declaration",
    "ArrayElement: Expr* callee, Token bracket, int count, Expr** indexes",
    "Declaration : Expr* initExpr, Declaration _declaration",
    "Function    : int arity, GroupingExpr* body, Expr* ui, Declaration _declaration, ObjFunction _function",
    ...
    "Primitive   : Token name, Type primitiveType",    
    "Reference   : Token name, Expr* declaration",
    "Return      : Token keyword, bool isUserClass, Expr* value",
    "Set         : Expr* object, Token name, Token op, Expr* value, Declaration* _declaration",
