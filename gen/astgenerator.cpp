...
int main(int argc, const char *argv[]) {
  ...
  const char *array1[] = {
    ...
    "Grouping    : Token name, int count, Expr** expressions, Compiler _compiler",
    ...
    "Function    : Expr* typeExpr, Token name, int arity, GroupingExpr* body, Expr* ui, ObjFunction _function, Declaration* _declaration",
