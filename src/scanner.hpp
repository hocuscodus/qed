...
#define KEYS_DEF \
    ...
    KEY_DEF( TOKEN_LEFT_PAREN, NULL, &Parser::grouping2, PREC_CALL ),  \
    KEY_DEF( TOKEN_RIGHT_PAREN, NULL, &Parser::endBlock, PREC_BLOCK ),  \
    KEY_DEF( TOKEN_LEFT_BRACE, NULL, &Parser::grouping2, PREC_NONE ),  \
    ...
    KEY_DEF( TOKEN_RIGHT_BRACKET, NULL, NULL, PREC_EXPRESSION ),  \
    KEY_DEF( TOKEN_COMMA, NULL, NULL, PREC_EXPRESSION ),  \
    KEY_DEF( TOKEN_DOT, NULL, &Parser::dot, PREC_MEMBER ),  \
    KEY_DEF( TOKEN_COMP, NULL, NULL, PREC_EXPRESSION ),  \
    ...
    KEY_DEF( TOKEN_BANG, &Parser::unary, NULL, PREC_EXPRESSION ),  \
    ...
    KEY_DEF( TOKEN_ARROW, NULL, NULL, PREC_EXPRESSION ),  \
    ...
    KEY_DEF( TOKEN_COLON, NULL, NULL, PREC_EXPRESSION ),  \
    KEY_DEF( TOKEN_BACKSLASH, NULL, NULL, PREC_EXPRESSION ),  \
    KEY_DEF( TOKEN_UNDERLINE, NULL, NULL, PREC_EXPRESSION ),  \
    KEY_DEF( TOKEN_COLON_COLON, NULL, NULL, PREC_EXPRESSION ),  \
    /* Literals. */ \
    KEY_DEF( TOKEN_IDENTIFIER, &Parser::variable, NULL, PREC_EXPRESSION ),  \
    KEY_DEF( TOKEN_STRING, &Parser::string, NULL, PREC_EXPRESSION ),  \
    KEY_DEF( TOKEN_INT, &Parser::intNumber, NULL, PREC_EXPRESSION ),  \
    KEY_DEF( TOKEN_FLOAT, &Parser::floatNumber, NULL, PREC_EXPRESSION ),  \
    KEY_DEF( TOKEN_VAL, NULL, NULL, PREC_EXPRESSION ),  \
    KEY_DEF( TOKEN_VAR, NULL, NULL, PREC_EXPRESSION ),  \
    KEY_DEF( TOKEN_TYPE_LITERAL, &Parser::primitiveType, NULL, PREC_EXPRESSION),  \
    /* Keywords. */ \
    KEY_DEF( TOKEN_AS, NULL, NULL, PREC_EXPRESSION ),  \
    KEY_DEF( TOKEN_DEF, NULL, NULL, PREC_EXPRESSION ),  \
    KEY_DEF( TOKEN_ELSE, NULL, NULL, PREC_EXPRESSION ),  \
    KEY_DEF( TOKEN_FALSE, &Parser::literal, NULL, PREC_EXPRESSION ),  \
    KEY_DEF( TOKEN_FOR, NULL, NULL, PREC_EXPRESSION ),  \
    KEY_DEF( TOKEN_FUN, NULL, NULL, PREC_EXPRESSION ),  \
    KEY_DEF( TOKEN_IF, NULL, NULL, PREC_EXPRESSION ),  \
    KEY_DEF( TOKEN_IMPORT, NULL, NULL, PREC_EXPRESSION ),  \
    KEY_DEF( TOKEN_MOD, NULL, NULL, PREC_EXPRESSION ),  \
    KEY_DEF( TOKEN_NEW, &Parser::unary, NULL, PREC_EXPRESSION ),  \
    KEY_DEF( TOKEN_PACKAGE, NULL, NULL, PREC_EXPRESSION ),  \
    KEY_DEF( TOKEN_PRINT, NULL, NULL, PREC_EXPRESSION ),  \
    KEY_DEF( TOKEN_RETURN, NULL, NULL, PREC_EXPRESSION ),  \
    KEY_DEF( TOKEN_SUPER, NULL, NULL, PREC_EXPRESSION ),  \
    KEY_DEF( TOKEN_THIS, NULL, NULL, PREC_EXPRESSION ),  \
    KEY_DEF( TOKEN_TRUE, &Parser::literal, NULL, PREC_EXPRESSION ),  \
    KEY_DEF( TOKEN_WHILE, NULL, NULL, PREC_EXPRESSION ),  \
    KEY_DEF( TOKEN_SEPARATOR, NULL, &Parser::nextStatement, PREC_STATEMENT ),  \
    KEY_DEF( TOKEN_NATIVE_CODE, &Parser::literal, NULL, PREC_EXPRESSION ),  \
    KEY_DEF( TOKEN_ERROR, NULL, NULL, PREC_NONE ),  \
    KEY_DEF( TOKEN_EOF, NULL, NULL, PREC_NONE ),  \
    KEY_DEF( TOKEN_INSERT, &Parser::swap, NULL, PREC_EXPRESSION ),
