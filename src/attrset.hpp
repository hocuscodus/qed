...
struct AttrSet {
  ...
  void init(int *offset, Point &zoneOffsets, std::array<long, NUM_DIRS> &arrayDirFlags, ValueStack<ValueStackElement> &valueStack, UIDirectiveExpr *directiveExpr, int parentRefreshFlags, ObjFunction *function);
...
struct ChildAttrSets : std::vector<AttrSet *> {
  ...
  DirFlags zFlags;
	...
	ChildAttrSets(int *offset, Point &zoneOffsets, int childDir, std::array<long, NUM_DIRS> &arrayDirFlags, ValueStack<ValueStackElement> &valueStack, UIDirectiveExpr *directiveExpr, int parentRefreshFlags, ObjFunction *function);
